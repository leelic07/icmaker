<template>
    <div id="ward">
        ...
        <div class="col-xs-24 button">
            <div class="col-xs-2">
                <input type="button" value="同意转监区" class="agree-button" @click = "transferExam(null,2,1)">
            </div>
            <div class="col-xs-2">
                <input type="button" value="拒绝转监区" class="reject-button" @click = "transferExam(null,2,2)">
            </div>
        </div>
