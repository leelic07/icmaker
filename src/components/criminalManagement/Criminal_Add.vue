    ...
    <div class="col-xs-24 crim-add">
      <div class="col-xs-23 add-box">
        <form class="form-horizontal" role="form">
          <div class="row add-row">
            ...
            <div class="col-xs-8">
              ...
              <div class="form-group">
                ...
                <div class="col-xs-14">
                  <input type="text" class="form-control" id="insideArchivesNumber"
                         v-model="prisonerInfo.insideArchivesNumber">
                </div>
              </div>
            </div>
            <div class="col-xs-8">
          ...
          <div class="row add-row">
              ...
              <div class="form-group">
                ...
                <div class="col-xs-12">
                  <input type="text" class="form-control" list="prisonList" placeholder="请选择" v-model="prisonName"
                         :disabled="prisonerId != undefined || prisons.length == 1">
            ...
            <div class="col-xs-10">
              <div class="form-group">
                ...
                <div class="col-xs-12">
                  <select class="form-control" id="prisonerDepartmentId" :disabled="prisonerId != undefined"
                          v-model="prisonerInfo.prisonDepartmentId">
          ...
          <div class="row add-row">
            <div class="row">
              <div class="input-group date form_date col-xs-5" data-date="" data-date-format="dd MM yyyy"
