  ...
  <div id="right-side" class="col-xs-20 pull-right">
    ...
    <div class="box" v-if="isDetail">
          ...
          <div class="col-xs-23 search-inner-box">
            ...
            <div class="row">
              <div class="col-xs-4 col-xs-push-10 button-box">
                <input type="button" value="搜索" class="search-button" @click="getCriminalFundSummary()">
              </div>
            </div>
      ...
      <div class="col-xs-24 form">
        <div class="col-xs-23">
          <table class="display table ic-table table-bordered" id="table_id_example">
            ...
            <tr v-for="cfsd in criminalFundSummaryDtos">
              <!--<td></td>-->
              <td>{{cfsd.prisonName}}</td>
              <td>{{cfsd.prisonDepartmentName}}</td>
              <td>{{cfsd.name}}</td>
              <td>{{cfsd.number}}</td>
        ...
        <!-- 表单底部-->
        <Page :itemSize="criminalFundSummarySize" :pageSize="pageSize" :indexPage="indexPage"
              v-on:search="getCriminalFundSummary"></Page>
...
//        downloadExcelUrl:'http://10.10.10.119:8080/icmaker/downFiles',//罪犯资金明细excel文件下载接口
    ...
    methods: {
      ...
      getTypeList() {//赋值类别列表
        this.typeList = [{"value": "", "name": "全部"}, {"value": 0, "name": "刷卡消费"}, {
          "value": 1,
          "name": "取现"
        }, {"value": 2, "name": "制卡费"}, {"value": 3, "name": "家属汇款"}, {"value": 4, "name": "低报酬"}, {
          "value": 5,
          "name": "IC卡资金"
        }]
      },
