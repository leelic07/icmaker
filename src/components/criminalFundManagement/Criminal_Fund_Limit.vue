<template>
  ...
  <div id="right-side" class="col-xs-20 pull-right">
      ...
      <div class="col-xs-23">
        <table class="display table ic-table" id="table_id_example">
          ...
          <tr v-for="fund in fundList">
            <td>
              <div class="info-check info-list-check" :prisonerId="fund.prisoner_id" :id="fund.id"></div>
            </td>
            ...
            <td><em class="agree-text" :prisonerId="fund.prisoner_id" :id="fund.id" :prisonerName="fund.name"
                    :monthMoney="fund.month_money" :dayMoney="fund.day_money" @click="setFund($event,1)">配置消费额度</em>
            </td>
          </tr>
          </tbody>
        </table>
    ...
    <!--设置限额 -->
    <div class="modal modal-confirm modal-bind" id="setConfirm" tabindex="-1" role="dialog"
          ...
          <div class="modal-body">
            ...
            <div class="clearfix bind-info">
              <ul class="pull-left clearfix bind-info-list" v-if="setType == 1">
                <li class="clearfix"><span class="pull-left info-label">罪犯名称</span><span class="pull-right">{{prisonerName}}</span>
                </li>
              </ul>
            </div>
            <div class="col-xs-24">
              ...
              <div class="form-group fee-input clearfix">
                ...
                <div class="col-xs-18 pull-left">
                  <input type="text" class="form-control col-xs-18 pull-left" id="monthMoney" placeholder="输入月限额"
                         v-model="monthMoney">
                </div>
              </div>
            </div>
