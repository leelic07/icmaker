<template>
    ...
    <div id="right-side" class="col-xs-20 pull-right">
                ...
                <div class="col-xs-23 search-inner-box">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6 text-box">
                            ...
                            <input type="text" class="form-control" id="" v-model='archivesNumber'>
                        </div>
                        <div class="col-xs-6 text-box">
		...
		<!--取现 -->
		<div class="modal modal-confirm modal-bind" id="cashOutConfirm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false">
		    <div class="modal-dialog">
		        <div class="modal-content">
		            ...
		            <div class="modal-body">
		                <h3>取现</h3>
		                <div class="col-xs-24">
		                    <input type="text" class="form-control fee-input" id="" placeholder="输入取现金额" v-model='cash'>
		                </div>
