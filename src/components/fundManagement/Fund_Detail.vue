        ...
        <div class="col-xs-23 search-box">
          <div class="col-xs-23 search-inner-box">
            ...
            <div class="row">
              ...
              <div class="col-xs-8 col-xs-offset-2 select-box">
      ...
      <div class='row'>
        <div class='prison-total col-xs-23'>
          <ul>
            ...
            <li class='pull-left text-green'>监狱总支出金额: <span
              class='text-red'>{{prisonCapitalOutTotal | currency}}元</span>
            </li>
          </ul>
        </div>
      </div>
...
<script>
  ...
  import PrintFundDetail from './Print_Fund_Detail.vue'
...
//          console.log(res);
      ...
      //监狱资金明细数据导出
      exportData() {
        axios.get('/prisonCapital/exportPrisonCapitalDetails', {
          params: {
            prisonId: this.prisonId,
            type: this.type,
            accountName: this.accountName,
...
//            console.log(this.filepath);
      ...
      //资金明细打印查询
      printPrisonCapitalDetails() {
        axios.get('prisonCapital/printPrisonCapitalDetails', {
          params: {
            prisonId: this.prisonId,
            type: this.type,
            accountName: this.accountName,
