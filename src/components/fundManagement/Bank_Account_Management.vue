          ...
          <div class="col-xs-23 form">
            <table class="display table ic-table" id="table_id_example">
              ...
              <tr v-for='bal in bankAccountList'>
                ...
                <td><em class="agree-text" @click='modifyAccount(bal.prisonBankAccountId,bal.bankAccountId)'>修改</em>
                </td>
                <td><em class="reject-text" @click='deleteAccount(bal.prisonBankAccountId,bal.bankAccountId)'>删除</em>
                </td>
              </tr>
              </tbody>
            </table>
