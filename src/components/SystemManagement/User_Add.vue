                    ...
                    <div class="col-xs-23 search-inner-box">
                        <div class="row">
                            <div class="col-xs-3 label-box">
                                <label class="pull-right" for="name">账户登录名 :</label>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-xs-3 label-box">
                                <label class="pull-right" for="name">密码 :</label>
                            </div>
                            <div class="col-xs-6 text-box">
                                <input type="text" class="form-control" id="">
                            </div>
                        ...
                        <div class="row">
                            <div class="col-xs-3 label-box">
                                <label class="pull-right" for="name">角色 :</label>
                            </div>
                            <div class="col-xs-6 select-box">
                                <select class="form-control">
                                    <option>全部</option>
                        ...
                        <div class="row">
                            <div class="col-xs-3 col-xs-push-3 button-box">
                                <input type="button" value="确认添加" class="search-button">
                            </div>
                        </div>
                    </div>
                </div>
